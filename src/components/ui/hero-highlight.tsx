...
export const HeroHighlight = ({
  ...
  const webkitMask = useMotionTemplate`radial-gradient(200px circle at ${mouseX}px ${mouseY}px, black 0%, transparent 100%)`;
  ...
  return (
    <motion.span
      ...
      style={{
        ...
        backgroundImage:
          "linear-gradient(120deg, rgb(199 210 254) 0%, rgb(216 180 254) 100%)",
        display: "inline",
      }}
      className={cn("relative inline px-0.5", className)}
    >
      {children}
    </motion.span>
  );
