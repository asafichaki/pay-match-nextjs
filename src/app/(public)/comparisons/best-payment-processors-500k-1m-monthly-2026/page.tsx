...
export async function generateMetadata(): Promise<Metadata> {
  return withSeoOverride("comparisons", "best-payment-processors-500k-1m-monthly-2026", baseMetadata);
}

export default function Page() {
  return <VolumeTierPage
    tier={tier}
    aeoAnswer={<AeoAnswer kind="comparisons" slug="best-payment-processors-500k-1m-monthly-2026" />}
    relatedLinks={<RelatedLinks kind="comparisons" slug="best-payment-processors-500k-1m-monthly-2026" />}
  />;
}
