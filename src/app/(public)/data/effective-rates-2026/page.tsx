...
// Effective rates by processor × volume × channel (online/in-person blended).
// Published 2026 rates + standard card-mix assumption (60% credit, 40% debit, 30% rewards).
// All numbers are illustrative composites suitable for benchmarking, not negotiated quotes.
interface Row {
  processor: string;
  channel: "Online" | "In-Person" | "Mixed";
  rates: [string, string, string, string]; // by tier
  pricingModel: string;
  notes: string;
}
